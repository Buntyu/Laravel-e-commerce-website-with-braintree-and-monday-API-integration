...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading main-color-bg">
            <h3 class="panel-title">Additional Services Commercial Printing</h3>
        </div>
        <div class="panel-body">
            ...
            @foreach($additional_services as $data)
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{url('adminpanel/pages/additional-services-commercial-printing/edit')}}" method="post">
