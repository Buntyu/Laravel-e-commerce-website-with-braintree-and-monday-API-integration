...
<body>
<div class="wrapper wrapper-landings wrapper-commercial">
    @include('main-menu')
    <div class="content-landing">
        <div class="sub-header">
            <div class="sub-inner"> <a class="nav_land nav1" href="{{url('print-your-own')}}"><span>PRINT YOUR OWN</span></a> <a class="nav_land nav2" href="{{url('gallery')}}"><span>PRINT FROM OUR GALLERY</span></a> <a class="nav_land nav3 active" href="{{url('commercial-printing')}}"><span class="active">COMMERCIAL PRINTING</span></a> </div>
        </div>
        <div class="content-inner">
            <div class="section1">

                <div class="section1-container">
                    <div class="section1-container-inner">
                        <div class="video">
                            <video autoplay poster="{{asset('img/commercial.png')}}" id="myvideo">
                                <source src="{{asset('video/commercial.mp4')}}" type="video/mp4"> </video>
                        </div>
                        <div class="left-outer">
                            <div class="after_video">
                                <h1>Commercial Printing</h1>
                                <p>
                                    We offer a fine art level of quality and service on a commercial scale. Our attention to detail and understanding of the demands that come with commercial printing makes us the go-to experts in canvas printing.
                                </p>
                            </div>
                            ...
                            <div class="contact-group">
                                    ...
                                    <div class="right-outer">
                                        ...
                                        <div class="left"> <a href="{{url('my-account/registration')}}"><img src="{{ asset('img/contact.png') }}" alt=""></a> </div>

                                        <div class="right">

                                            <a class="title" href="{{url('/#5thPage')}}">Contact us for a quote</a>
                ...
                <div class="group">
                    ...
                    <div id="slider1" class="owl-carousel owl-theme">
                        @foreach($our_clients as $data)
                            <div class="item">
                                <div class="box"><img src="{{ asset('assets/upload') }}/{{$data->image}}" alt=""></div>
                            </div>
                        @endforeach
                    </div>
                    <!--		slider - end    	-->
            ...
            <div class="section3">
                <h1>Testimonials</h1> <img src="{{ asset('img/landing-slider2.png') }}" alt="">
                <!--		slider		-->
                <div class="comment">
